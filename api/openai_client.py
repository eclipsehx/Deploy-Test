...
class OpenAIClient(ModelClient):
    ...
    def __init__(
        ...
        Args:
            ...
            base_url (str): The API base URL to use when initializing the client.
            env_api_key_name (str): The environment variable name for the API key. Defaults to `"OPENAI_API_KEY"`.
            default_headers (Optional[Dict[str, str]], optional): Default headers to include in all requests. Defaults to None.
        """
        super().__init__()
    ...
    def init_sync_client(self):
        ...
        return OpenAI(api_key=api_key, base_url=self.base_url, default_headers=self._default_headers)
    ...
    def init_async_client(self):
        ...
        return AsyncOpenAI(api_key=api_key, base_url=self.base_url, default_headers=self._default_headers)
